...
namespace AnnualReports.Application.Core.Interfaces
{
    public interface IFundService
    {
        ...
        List<Fund> GetAllFunds(int? year, DbSource? dbSource = DbSource.ALL, string displayName = null, string fundNumber = null, bool? isActive = null, PagingInfo pagingInfo = null);
