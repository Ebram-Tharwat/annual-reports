...
namespace AnnualReports.Infrastructure.Core.Mappings.DistDb
{
    ...
    public class Gl10110DistDbConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Gl10110>
    {
        public Gl10110DistDbConfiguration()
            : this("dbo")
        {
        }

        public Gl10110DistDbConfiguration(string schema)
        {
